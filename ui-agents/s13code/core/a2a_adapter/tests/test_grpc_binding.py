...
from s13code.core.a2a_adapter.grpc_binding import A2AGrpcClient, A2AGrpcServer
from s13code.core.a2a_adapter.server import A2ADemoServer
from s13code.core.a2a_adapter.trust import sign_card


def _card():
    return {
        "name": "Local gRPC specialist", "description": "S13Core test agent", "version": "1.0.0",

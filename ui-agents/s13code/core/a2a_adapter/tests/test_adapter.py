...
from s13code.core.a2a_adapter.trust import AgentCardTrustPolicy, CardTrustError, sign_card
...
def card():
    return {
        "name": "Local specialist", "description": "S13Core test agent", "version": "1.0.0",

...
@pytest.mark.asyncio
async def test_s13code_calls_gateway_without_owning_provider_keys(monkeypatch):
    ...
    monkeypatch.setenv("S13_GATEWAY_PROVIDER", "gemini")
    ...
    assert payload["agent"] == "s13_answer"
